...
typedef VOID (WINAPI *PFNVDD_UCREATE)(USHORT pdb);
typedef VOID (WINAPI *PFNVDD_UTERMINATE)(USHORT pdb);
typedef VOID (WINAPI *PFNVDD_UBLOCK)();
typedef VOID (WINAPI *PFNVDD_URESUME)();
